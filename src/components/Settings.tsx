...
function Settings({ onSoundChange }: inputProps) {
  ...
  return (
    <div className="absolute top-full left-0 flex h-full w-full flex-col bg-gray-100 dark:bg-gray-800">
      ...
      <div className="flex flex-1 [&>*]:flex-1 [@media(max-aspect-ratio:16/9)]:flex-col">
        <div className="dark:even:bg-pruple-700 flex w-full justify-center border-t-1 border-gray-400 bg-purple-100 px-11 py-3 grayscale-70 even:bg-purple-200 dark:bg-purple-900 dark:text-white [@media(min-aspect-ratio:16/9)]:px-2">
          <div className="flex max-h-max items-center self-center-safe [@media(min-aspect-ratio:16/9)]:flex-col">
            <div className="text-md w-36 pr-8 text-right">Count-In Time</div>
            <div className="flex items-center self-center-safe">
              <input
                id="countInTime"
                type="text"
        ...
        <div className="dark:even:bg-pruple-700 flex w-full justify-center border-t-1 border-gray-400 bg-purple-100 px-11 py-3 grayscale-70 even:bg-purple-200 dark:bg-purple-900 dark:text-white dark:even:bg-purple-500 [@media(min-aspect-ratio:16/9)]:px-2">
          <div className="flex max-h-max items-center self-center-safe [@media(min-aspect-ratio:16/9)]:flex-col">
