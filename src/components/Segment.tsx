...
function Segment({ durationMilliseconds, setComplete, trigger }: inputProps) {
  ...
  return (
    <section
      className="first:-[.6] mt-8 ml-10 flex min-h-8 w-xl flex-1 justify-between rounded-lg bg-gray-200 p-2 pr-5 first:origin-left first:scale-[.6] first:!bg-gray-700 first:opacity-50 odd:bg-gray-500 first:[&>:first-child]:text-white"
